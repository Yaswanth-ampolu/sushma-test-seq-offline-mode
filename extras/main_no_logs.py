"""
Main entry point for the Spring Test App - No Logs Version.
This version does not create or use a logs folder at all.
"""
import sys
import os
import logging
...
def setup_console_logging():
    """Set up logging to console only, with no file output."""
    ...
    logging.info("Logging to console only (no log files)")
